...
public class Player extends Object {
    public static final int DEFAULT_ARROW = 2;
    ...
    private int arrows =DEFAULT_ARROW;
    private boolean cowardPlayer = false;
	...
	public boolean isCowardPlayer() {
		return cowardPlayer;
	}

	public void setCowardPlayer(boolean cowardPlayer) {
		this.cowardPlayer = cowardPlayer;
	}
